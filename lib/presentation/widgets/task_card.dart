...
class TaskCard extends StatelessWidget {
  ...
  Widget subTitleWidget({required Task task, required Color taskColor}) {
    return Padding(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Text(
              "${getTaskTypeEmoji(task.taskType)} ${task.taskType
                  .toUpperCase()}",
              style: const TextStyle(
                fontSize: 13,
          ...
          Text(
            "Due: ${task.dueDate != null ? DateFormatter.toLongMonthDayYear(
                task.dueDate.toString()) : "Anytime"}",
            style: TextStyle(
              fontSize: 13,
