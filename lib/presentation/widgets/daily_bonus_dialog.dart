...
class _DailyBonusDialogState extends State<DailyBonusDialog> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Welcome back! Here's your daily reward for staying productive.",
                  textAlign: TextAlign.center,
                  style: GoogleFonts.poppins(
                    fontSize: 14,
  ...
  Widget _buildRewardItem(BuildContext context, {required IconData icon, required String label, required Color color}) {
    return Expanded(
      child: Container(
